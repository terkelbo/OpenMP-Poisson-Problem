...
TARGET_WRITE = poisson_writefiles
...
all: $(TARGET_NAIVE) $(TARGET_1) $(TARGET_2) $(TARGET_3) $(TARGET_WRITE)
...
$(TARGET_WRITE): $(OBJ_DIR)/main_writefiles.o $(OBJ_DIR)/jacobi_naive.o $(OBJ_DIR)/gaussseidel_naive.o $(OBJ_DIR)/inittools_naive.o
	$(CC) -o $@ $(SOFLAGS) $(OBJ_DIR)/main_writefiles.o $(OBJ_DIR)/jacobi_naive.o $(OBJ_DIR)/gaussseidel_naive.o $(OBJ_DIR)/inittools_naive.o $(XLIBS)
...
$(OBJ_DIR)/main_naive.o: $(SRC_DIR)/main_naive.c include/jacobi_naive.h include/gaussseidel_naive.h include/inittools_naive.h
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
$(OBJ_DIR)/main_writefiles.o: $(SRC_DIR)/main_writefiles.c include/jacobi_naive.h include/gaussseidel_naive.h include/inittools_naive.h
	$(CC) $(CPPFLAGS) $(CFLAGS) -c $< -o $@
