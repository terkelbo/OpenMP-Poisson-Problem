...
void
init_u(int n, char * algo, double u_start, double * restrict u_old, double * restrict u_new){
...
void
init_u_test(int n, char * algo, double * restrict u_old, double * restrict u_new){
